...
export function SuchmodusCockpit({
  ...
  return (
    <div className={styles.page}>
        ...
        <div className={styles.heroFilterBar}>
          ...
          <Link href="/suchmodus/search" className={styles.heroFilterCircle}>
            <Image
              ...
              width={24}
              height={24}
              className={styles.heroCircleIcon}
            />
          </Link>
        </div>
          ...
          <div style={{ position: "relative", zIndex: 1, padding: "40px clamp(20px, 5vw, 60px)" }}>
            ...
            >
              ...
              <Image
                ...
                height={60}
                style={{
                  filter: "invert(62%) sepia(40%) saturate(500%) hue-rotate(5deg)",
                  flexShrink: 0,
                }}
              />
            </div>
      ...
      <div className={styles.sectionPadded}>
        <h2
          className="text-h1 text-h1--medium"
          style={{ color: "var(--neutral-grey-600)", textAlign: "center", marginBottom: 48 }}
        >
          Kostüm Netzwerk
        </h2>
