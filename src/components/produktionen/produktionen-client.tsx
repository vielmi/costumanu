    ...
    productions: [
      {
        ...
        year: "2025/2026",
        status: "active",
        image: "/images/suchmodus-tanz.jpg",
      },
      {
        title: "Gods' Dawn",
        year: "2025/2026",
        status: "active",
        image: "/images/suchmodus-oper.jpg",
      },
      {
        title: "Hello Earth!",
        year: "2025/2026",
        status: "active",
        image: "/images/suchmodus-barock-scene.jpg",
      },
      {
        title: "Gilgamesch, mein Sternenschiff",
        year: "2025/2026",
        status: "active",
        image: "/images/cockpit-auffuehrungen.jpg",
      },
      {
        title: "Die Glasmenagerie",
        year: "2025/2026",
        status: "active",
        image: "/images/suchmodus-oper-scene.jpg",
      },
    ],
  },
  {
    ...
    productions: [
      ...
      },
      {
        ...
        year: "2024/2025",
        status: "done",
        image: "/images/suchmodus-schauspiel.jpg",
      },
    ],
  },
  ...
  return (
    <div
      style={{
        ...
        height: 240,
        background:
          production.status === "active" ? "var(--secondary-800)" : "var(--secondary-900)",
        cursor: "pointer",
      }}
    >
      {production.image && (
    ...
    <div style={{ marginBottom: 24 }}>
      <div
        style={{
          ...
          paddingBottom: 12,
          marginBottom: open && season.productions.length > 0 ? 16 : 0,
        }}
      >
        <span
          style={{
          ...
          {open ? (
            ...
            <span
              style={{
                ...
                lineHeight: 1,
                fontWeight: "var(--font-weight-300)" as React.CSSProperties["fontWeight"],
                color: "var(--neutral-grey-500)",
              }}
            >
              +
