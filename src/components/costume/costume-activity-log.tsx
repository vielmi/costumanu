                    ...
                    >
                      ...
                      <span
                        style={{
                          ...
                          background:
                            entry.action_type === "created"
                              ? "var(--accent-01-light, #e8f5e9)"
                              : "var(--tertiary-100, #edf0f3)",
                    ...
                    {(entry.production_title ||
                      ...
                      >
                        {(entry.production_title || entry.season) && (
                          <Row
                            label="Stück & Spielsaison"
                            value={[entry.production_title, entry.season]
                              .filter(Boolean)
                              .join(", ")}
                          />
                        )}
                        {entry.role_name && <Row label="Rolle" value={entry.role_name} />}
                        {entry.director_name && <Row label="Regie" value={entry.director_name} />}
                      </div>
                    )}
                  </div>
                </div>
